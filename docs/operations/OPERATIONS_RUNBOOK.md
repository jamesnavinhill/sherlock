...
- Board-agent runtime incidents belong in this runbook. Board-agent rail layout, docking, and long-term panel-composition issues are intentionally deferred to the future second dockable agent-panel stream unless they block current runtime use.
