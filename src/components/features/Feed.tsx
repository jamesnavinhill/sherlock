  ...
  const renderSettingsPanel = () => (
    <div className="osint-menu-panel absolute top-20 right-6 z-50 w-96 border border-zinc-700 bg-zinc-900 animate-in slide-in-from-top-2 fade-in duration-200">
      ...
      <div className="p-5 space-y-5">
        {/* Counts */}
        <div>
          <label className="block osint-meta-label mb-3">
            Result Limit Configuration
          </label>
          <div className="flex items-center justify-between">
            <div className="flex items-center osint-meta-value text-zinc-300">
            ...
            <div className="flex gap-2">
              {[4, 8, 12, 16].map((num) => (
                <button
                  ...
                  className={`w-8 h-6 flex items-center justify-center border osint-meta-label transition-all ${feedConfig.limit === num ? 'osint-button-soft' : 'bg-transparent text-zinc-500 border-zinc-700 hover:border-zinc-500'}`}
                >
                  {num}
                </button>
              ))}
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full h-20 bg-black border border-zinc-700 p-2 osint-body-small text-zinc-300 focus:border-osint-primary outline-none resize-none placeholder-zinc-700"
          />
        ...
        <div className="pt-4 border-t border-zinc-800">
          <div className="flex items-center justify-between mb-3">
            <label className="osint-meta-label">
              Background Watch
            </label>
            <button
              type="button"
          ...
          {feedConfig.autoRefresh && (
            <div className="flex items-center justify-between">
              <span className="osint-body-quiet">Interval</span>
              <div className="w-28">
                <OsintSelect
                  ...
                  triggerClassName="px-2 py-1 pr-8 osint-meta-value text-zinc-400"
                  options={[
        ...
        <div className="pt-4 border-t border-zinc-800 flex items-center justify-between">
          <button
            ...
            className="flex items-center osint-meta-label text-zinc-500 hover:text-white"
          >
            Reset Defaults
          </button>
          <button
            ...
            : feedItems.map((item) => (
                ...
                >
                  <div className={`${CHROME_CARD_SECTION_CLASS} mb-4 flex items-start justify-between gap-3 px-3 py-2`}>
                    ...
                    <span className="osint-body-quiet">{item.timestamp}</span>
                  </div>

                  <h3 className="osint-title-section mb-3 line-clamp-2 min-h-[3.5rem] text-zinc-200 transition-colors group-hover:text-white">
                    {item.title}
                  </h3>

                  <p className="line-clamp-3 osint-body-small text-zinc-500">
