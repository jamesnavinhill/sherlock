        ...
        <div className="sticky top-0 z-30 h-20 px-6 bg-black/95 backdrop-blur-md border-b border-zinc-800 flex items-center justify-between shadow-lg flex-shrink-0">
            <div className="flex items-center space-x-4 min-w-0 flex-1">
                ...
                <button
                    ...
                    className={`hidden md:flex items-center space-x-2 px-3 py-1.5 border transition-all ${leftPanelOpen ? 'bg-zinc-800 border-white text-white' : 'bg-black border-zinc-700 text-zinc-400 hover:text-white'}`}
                >
