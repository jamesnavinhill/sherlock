...
export class ChatRepository {
    ...
    static async getMessagesBySessionIds(sessionIds: string[]): Promise<Record<string, ChatMessage[]>> {
    ...
    static async updateSession(
        ...
        await db
            ...
            .set({
                title: patch.title,
                status: patch.status,
                sourceReportId: patch.sourceReportId === undefined ? undefined : patch.sourceReportId || null,
                ...
                metadataJson: patch.metadata === undefined ? undefined : patch.metadata ? JSON.stringify(patch.metadata) : null,
    ...
    static async updateMessage(
        ...
        await db
            ...
            .set({
                ...
                status: patch.status,
                citationsJson: patch.citations === undefined ? undefined : patch.citations ? JSON.stringify(patch.citations) : null,
                metadataJson: patch.metadata === undefined ? undefined : patch.metadata ? JSON.stringify(patch.metadata) : null,
